...
import {commonFetchOptions, rc, getPortalId, getCSRFToken} from './common'
...
async function getContact(
  ...
  let res = await fetch.post(url, data, commonFetchOptions(headers))
  console.log(res, 'rrr')
  if (res === '') {
    console.log(res, 'rreer')
    res = await fetch.post(url, data, commonFetchOptions(headers))
  }
  if (res && res.contacts) {
    return res
  } else {
