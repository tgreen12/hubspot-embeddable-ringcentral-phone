...
if (clientID || appServer) {
  appConfigQuery = `?newAdapterUI=1&userAgent=${thirdPartyConfigs.serviceName}_extension%2F${appVersion}&disableActiveCallControl=false&appKey=${clientID}&appServer=${encodeURIComponent(appServer)}`
}
